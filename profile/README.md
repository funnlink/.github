...
FunnLink 由 Edward Yang（杨进）创立于成都，是一家以开源为核心、AI 与量化交易为技术驱动的科技公司。我们构建可被全球开发者复用的基础设施，旗下产品覆盖电商系统、内容平台、AI 量化交易等多个领域。

我们相信：**开源不只是代码共享，更是工程文化的输出**。
...
- **[xmindpy](https://github.com/funnlink/xmindpy)** — 现代 Python SDK，XMind 2020+ JSON 格式
...
- **开源贡献** — 任何产品仓库都欢迎 PR、issue 与功能建议
- **企业服务** — InnoShop 企业版、私有化部署、定制开发
- **技术咨询** — 电商系统架构、量化交易系统设计

📮 联系：edward@innoshop.com
